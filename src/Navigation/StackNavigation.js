...
import CompteScreen from "../Screens/Releveur/CompteurScreen";
import ChangeTourneScreen from "../Screens/Compteurs/ChangeTourneScreen";
...
export default function StackNavigation({ navigation }) {
    return (
        <Stack.Navigator screenOptions={globalScreenOptions}>
            ...
            <Stack.Screen
                options={{ tabBarLabelStyle: { fontSize: 14 }, headerTitle: 'Changement de Tourné', }}
                name="chaneTourne" component={ChangeTourneScreen}
            />
            <Stack.Screen
